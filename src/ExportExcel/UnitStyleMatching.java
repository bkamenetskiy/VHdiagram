...
class UnitStyleMatching {
    ...
    private CellStyle styleDimensionless;          // безразмерные
    private DataFormat precisionDimensionless;
    ...
    protected void createCellStyle(XSSFWorkbook dataBook, Unit[] unitOutput) {
        ...
        // безразмерные
        this.precisionDimensionless = dataBook.createDataFormat();
        this.styleDimensionless = dataBook.createCellStyle();
        // настройка стиля
        this.styleDimensionless.setAlignment(HorizontalAlignment.CENTER);                                                      // горизонтальноен выравнивание
        this.styleDimensionless.setVerticalAlignment(VerticalAlignment.CENTER);                                                // вертикальное выравнивание
        this.styleDimensionless.setDataFormat(this.precisionDimensionless.getFormat(unitOutput[6].getPrecision()));              // точность
